...
public class HCConfirmationActivity extends Activity {
	TextView mTxttid;
	TextView mTxtpname;
	TextView mTxthname;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_hcconfirmation);
...
//		mTxtpname = (TextView) findViewById(R.id.text_name);
//		mTxtpname.setText(mHolder.getUser_name());
//		mTxthname = (TextView) findViewById(R.id.text_hname);
//		mTxthname.setText(mHolder.getName());
//		mTxtspecial = (TextView) findViewById(R.id.text_specialization);
//		mTxtspecial.setText(mHolder.getSpecial());
//		mTxtaddress = (TextView) findViewById(R.id.text_hosaddress);
...
//		mTxtpass = (TextView) findViewById(R.id.text_priority);
